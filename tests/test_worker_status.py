...
def test_worker_warning_summary_details_refresh_recovery_and_mobile(store,tmp_path):
    ...
    try:
        ...
        with sync_playwright() as pw:
            ...
            page.goto(client.base_url+'/#overview')
            ...
            expect(page.locator('#worker-alert-count')).to_contain_text('2 个范围 · 3 项异常')
            ...
            expect(page.locator('#worker-alert-rows tr')).to_have_count(3)
            expect(page.locator('#worker-alert-rows')).to_contain_text('沪深300成分')
            expect(page.locator('#worker-alert-rows')).not_to_contain_text('Tushare')
            ...
            expect(page.locator('#worker-alert-rows tr')).to_have_count(1)
            ...
            expect(page.locator('#runtime')).to_be_visible()
