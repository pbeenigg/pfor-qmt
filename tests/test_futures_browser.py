...
from browser_helpers import choose_many, navigate, sync_report, confirm_export, new_dataset
        ...
        with sync_playwright() as pw:
            ...
            for resource in ('calendar','warehouse','holding','mapping'):
                ...
                with page.expect_response(lambda r:r.url.endswith('/futures/export') and r.request.method=='POST') as exported:
                    confirm_export(page,'#futures-csv')
            ...
            expect(page.locator('nav [data-route=calendar]')).to_have_count(1)
